...
data[0].make_animation(path='./plot/satepart')
#data[0].plot_St_t()
#data[0].make_animation(path='./plot/St_t')
data[0].plot_jumpT()
data[0].plot_pebble_Sigma(tL =np.array(np.array([1e6,5e6,6e6,10e6,15e6])*cgs.yr))
